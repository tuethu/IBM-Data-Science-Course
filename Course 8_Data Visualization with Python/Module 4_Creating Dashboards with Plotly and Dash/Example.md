...
- Compute_info function description: This function takes in airline data and selected year as an input and performs computation for creating charts and plots.
- Arguments:
...
- Callback Function: Function that returns fugures using the provided input year.
...
- Callback decorator: We have 5 output components added in a list. Update output component id parameter with the ids provided in the dcc.Graph() component and set the component property as figure. One sample has been added to the skeleton.
